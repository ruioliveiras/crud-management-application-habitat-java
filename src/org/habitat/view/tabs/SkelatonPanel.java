...
public class SkelatonPanel extends javax.swing.JPanel {
    ...
    public SkelatonPanel(AppState.ViewDimension view, JPanel toolbar) {
        initComponents();
...
//        }
    ...
    public void setDimension(UIDimension<?> a) {
        pDetails.removeAll();
        pDetails.add(appState.adminSelected().panelDetails());
        pDetails.validate();
    }
    ...
    private void initComponents() {
        ...
        btnEndTaks1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnEndTaks1ActionPerformed(evt);
            }
        });
    ...
    private void btnEndTaks1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEndTaks1ActionPerformed
    }//GEN-LAST:event_btnEndTaks1ActionPerformed
